...
class MyMoviesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        var sectionName = fetchResultsController.sections?[section].name
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            let movie = fetchResultsController.object(at: indexPath)
            movieController.deleteFromCoreData(movie: movie)
        }
    }
}
...
extension MyMoviesTableViewController: ToggleSeenDelegate {
